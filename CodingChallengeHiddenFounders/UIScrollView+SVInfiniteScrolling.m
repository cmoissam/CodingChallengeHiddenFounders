...
//                return;
//        }
        SVInfiniteScrollingView *view = [[SVInfiniteScrollingView alloc] initWithFrame:CGRectMake(0, self.contentSize.height-10, self.bounds.size.width, SVInfiniteScrollingViewHeight)];
...
- (void)setShowsInfiniteScrolling:(BOOL)showsInfiniteScrolling {
    ...
    if(!showsInfiniteScrolling) {
        ...
        if (!self.infiniteScrollingView.isObserving) {
            ...
            self.infiniteScrollingView.frame = CGRectMake(0, self.contentSize.height-10, self.infiniteScrollingView.bounds.size.width, SVInfiniteScrollingViewHeight);
        }
    }
}
